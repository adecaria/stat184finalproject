...
Lines 24-31: Importing CarbonData table from the wikipedia page on world carbon emissions\
Line 65: imported CountryData table

(B) .Rmd Line numbers for inspecting data intake:  
Lines 74 & 75: Viewing the imported CarbonData table from Wikipedia \
Lines 81 & 82: Viewing the CountryData table from the DataComputing package
